      ...
      <footer className="border-t mt-12 py-10 text-sm text-zinc-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span>
              For education in safe, legal environments (VMs, lab networks). Do <strong>not</strong> attack systems without explicit written consent.
            </span>
          </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center gap-8 py-16">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full mt-6">
        <HomeFeature to="/material" icon={<BookOpen className="w-5 h-5"/>} title="Organized Material" desc="Clear theory + practical guidance." />
        <HomeFeature to="/assistant" icon={<Brain className="w-5 h-5"/>} title="AI Assistant" desc="Ask questions, find topics fast." />
        <HomeFeature to="/projects" icon={<Box className="w-5 h-5"/>} title="Hands-on Projects" desc="Practice safely in a VM lab." />
        <HomeFeature to="/about" icon={<Sparkles className="w-5 h-5"/>} title="Easy → Deep" desc="Pick your difficulty level." />
      </div>
...
function HomeFeature({ to, icon, title, desc }) {
  return (
  ...
  return (
    <div className="grid lg:grid-cols-[1fr_320px] gap-10">
      ...
      <div className="space-y-4">
        <Card className="rounded-2xl shadow-sm"><CardContent className="p-4 text-sm text-zinc-700">Practice <strong>only</strong> inside a virtual machine or isolated lab network.</CardContent></Card>
        <GoogleAdSenseSlot />
      </div>
    </div>
  );
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="space-y-4">
          <p className="text-zinc-800 leading-relaxed">
            I am <strong>Balkar Singh</strong> and I created this website for ethical hacking learners to understand concepts clearly.
            You'll find theory and practical projects to try <strong>inside a virtual machine</strong> at home.
          </p>
          <div className="rounded-xl border p-4 bg-white">
            <h3 className="font-semibold mb-2">Legal Notice</h3>
            <p className="text-sm text-zinc-700">
              This website is for <strong>educational purposes</strong> only. Use ethical hacking techniques in safe environments like
              virtual machines and isolated lab networks. <strong>Do not</strong> attempt to access or attack any system without
